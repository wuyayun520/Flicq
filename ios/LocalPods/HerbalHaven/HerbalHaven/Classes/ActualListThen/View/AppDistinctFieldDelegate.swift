...
fileprivate let str_sectionName:[UInt8] = [0x87,0x80,0x87,0x9a,0xc6,0x8d,0x81,0x8a,0x8b,0x9c,0xd4,0xc7,0xce,0x86,0x8f,0x9d,0xce,0x80,0x81,0x9a,0xce,0x8c,0x8b,0x8b,0x80,0xce,0x87,0x83,0x9e,0x82,0x8b,0x83,0x8b,0x80,0x9a,0x8b,0x8a]

private func mainMake(send num: UInt8) -> UInt8 {
    return num ^ 238
}

/*: "Enter phone number" :*/
fileprivate let str_playerData:String = "share return addEnte"
fileprivate let str_sizeUserQuickTitle:String = "return progress type cookiene nu"

/*: "Enter Email Address" :*/
fileprivate let str_voiceName:String = "Entenumber bottom"
fileprivate let str_constraintText:String = "ail video view"
fileprivate let str_galleryValue:[Character] = ["e","s","s"]

/*: "F4F4F4" :*/
fileprivate let str_requestValue:[Character] = ["F","4","F","4","F","4"]

/*: "America(+1)" :*/
fileprivate let str_equalColorName:[Character] = ["A","m","e","r","i"]
fileprivate let str_reasonReportData:[Character] = ["c","a","(","+","1",")"]

/*: "area_code_down_icon" :*/
fileprivate let str_succeedName:String = "view roomarea_"
fileprivate let str_fillBiologyTitle:String = "than"
fileprivate let str_topContent:[Character] = ["o","w","n","_","i","c","o","n"]

/*: "BBBBBB" :*/
fileprivate let str_clearData:[Character] = ["B","B","B","B","B","B"]

/*: "btn_field_delete_icon" :*/
fileprivate let str_delayTopValue:String = "btn_fcorner action cur share"
fileprivate let str_signData:String = "size index view textelete_"

/*: "Password" :*/
fileprivate let str_makeName:String = "Pasadjust as up format"
fileprivate let str_pinDataListName:[Character] = ["s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let str_maximumText:String = "cccccc"

/*: "or" :*/
fileprivate let str_shareName:String = "OR"

/*: "F5F5F5" :*/
fileprivate let str_centerData:[Character] = ["F"]
fileprivate let str_photoTalkData:String = "5F5F5self gift return ex to"

/*: "Next" :*/
fileprivate let str_markData:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let str_lastName:[Character] = ["L","o","g","i","n"]
fileprivate let str_bottomLabelData:[Character] = [" ","b","y"," ","p"]
fileprivate let str_onlineText:[Character] = ["a","s","s","w","o","r","d"]

/*: "Login by OTP" :*/
fileprivate let str_layerData:String = "view picLogin"

/*: "#8C7AFF" :*/
fileprivate let str_controlBackValue:String = "#8C7AFFif add"

/*: "Login" :*/
fileprivate let str_overResultTitle:[Character] = ["L","o","g","i","n"]

/*: "Send verification" :*/
fileprivate let str_pushContent:String = "let object normal giftSend "
fileprivate let str_fillName:String = "playeration"
...
// __CLOSE_PRINT__
//
//  AppDistinctFieldDelegate.swift
//  AbroadTalking
//
...
class AppDistinctFieldDelegate: UIView, UITextFieldDelegate {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_sectionName.map{mainMake(send: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (String(str_requestValue)))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(str_equalColorName) + String(str_reasonReportData))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.markTag(name: (String(str_succeedName.suffix(5)) + "code_" + str_fillBiologyTitle.replacingOccurrences(of: "than", with: "d") + String(str_topContent)))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (String(str_requestValue)))
        ...
        textField.clipsToBounds = true
        //: textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.biologyLaboratoryEqual(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: "BBBBBB")!])
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.biologyLaboratoryEqual(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (String(str_clearData)))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.markTag(name: (String(str_delayTopValue.prefix(5)) + "ield_d" + String(str_signData.suffix(6)) + "icon")), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(str_makeName.prefix(3)) + String(str_pinDataListName)).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (str_maximumText.uppercased()))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_centerData) + String(str_photoTalkData.prefix(5))))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(str_markData)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.viewColor(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(str_lastName) + String(str_bottomLabelData) + String(str_onlineText)).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(str_layerData.suffix(5)) + " by OTP").localized, for: .selected)
        ...
        btn.layer.borderColor = UIColor(hex: (String(str_controlBackValue.prefix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension AppDistinctFieldDelegate {
    /// 更新提交按钮状态
    ...
    @objc private func event(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(str_overResultTitle)).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(str_markData)).localized, for: .normal)
        }
    ...
    func passage() {
        ...
        commitButton.setTitle((String(str_pushContent.suffix(5)) + "verif" + str_fillName.replacingOccurrences(of: "player", with: "ic")).localized, for: .normal)
    }
}
...
extension AppDistinctFieldDelegate {
    ...
    private func setupPlayWearable() {
    ...
    private func afterHoldFastTotaleraction() {
        //: commitButton.rx.tap
        commitButton.rx.tap
