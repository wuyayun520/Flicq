...
/*: _" :*/
fileprivate let str_succeedData:[Character] = ["_"]

/*: ".png" :*/
fileprivate let str_siblingName:String = ".pngend page text"
...
@objcMembers public class UserCellData: ResultCellData {
    ...
    override public var msgModel: TitleTagJsonModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.buildTo(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func labAdd(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kLet_successErrData)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + RecordAppManager.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + RecordAppManager.share.loginUserMode.userID + (String(str_siblingName.prefix(4)))
        ...
        let imageData = UIImage.consultSize(image, distance: 2 * 1024)
