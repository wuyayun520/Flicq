...
/*!消息体数据*/
//: @class UpModel, ConsumerModel, MinimizeModel, AbTalkingChatMsgGiftModel, TipsObjectJsonModel, RowModelType, HiddenJsonModel, BriquetModel, AbTalkingChatMsgCustomSendModel, AbTalkingChatMsgQuoteModel, AbTalkingChatMsgQuoteDataModel, WantGiftModel;
@class UpModel, ConsumerModel, MinimizeModel, TimeJsonModel, TipsObjectJsonModel, RowModelType, HiddenJsonModel, BriquetModel, UpwardJsonModel, CopernicanSystemJsonModel, FactorNameJsonModel, TitleJsonModel;

//: @interface TitleTagJsonModel : BaseJsonModel
@interface TitleTagJsonModel : BaseJsonModel

//: @property (nonatomic, strong)UpModel *msgInfo;
@property (nonatomic, strong)UpModel *msgInfo;

//: @property (nonatomic, strong)ConsumerModel *user;
@property (nonatomic, strong)ConsumerModel *user;

//: @property (nonatomic, strong)MinimizeModel *toUser;
@property (nonatomic, strong)MinimizeModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)TimeJsonModel *gift;

//: @property (nonatomic, strong)TipsObjectJsonModel *tips;
@property (nonatomic, strong)TipsObjectJsonModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)CopernicanSystemJsonModel *quoteMsgInfo;

//: @property (nonatomic, strong)RowModelType *userInfoModel;
@property (nonatomic, strong)RowModelType *userInfoModel;
...
//: @interface UpModel : BaseJsonModel
@interface UpModel : BaseJsonModel
...
//: @property (nonatomic, strong) HiddenJsonModel *intimatePhoto; 
@property (nonatomic, strong) HiddenJsonModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) BriquetModel *video; 
@property (nonatomic, strong) BriquetModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) UpwardJsonModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) TitleJsonModel *wantGift; /// 想要礼物
...
/// 私密照片模型
//: @interface HiddenJsonModel : BaseJsonModel
@interface HiddenJsonModel : BaseJsonModel
...
/// 视频（包含私密视频）模型
//: @interface BriquetModel: BaseJsonModel
@interface BriquetModel: BaseJsonModel
...
@interface UpwardJsonModel: BaseJsonModel
...
//消息发送人
//: @interface ConsumerModel : BaseJsonModel
@interface ConsumerModel : BaseJsonModel
...
//对方
//: @interface MinimizeModel : BaseJsonModel
@interface MinimizeModel : BaseJsonModel
...
@interface TimeJsonModel : BaseJsonModel
...
//: @interface TipsObjectJsonModel : BaseJsonModel
@interface TipsObjectJsonModel : BaseJsonModel
...
@interface TitleJsonModel : BaseJsonModel
...
@interface CopernicanSystemJsonModel : BaseJsonModel
...
@property (nonatomic, strong) FactorNameJsonModel *renderData;
...
@interface FactorNameJsonModel : BaseJsonModel
