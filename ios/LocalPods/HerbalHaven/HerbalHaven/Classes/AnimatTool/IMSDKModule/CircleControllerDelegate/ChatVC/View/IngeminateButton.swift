...
/*: "icon_chat_start" :*/
fileprivate let str_deadlineBlockData:[Character] = ["i","c","o","n","_","c","h","a","t","_"]
fileprivate let str_modelMakeData:[Character] = ["s","t","a","r","t"]

/*: "#EBEBEB" :*/
fileprivate let str_hiddenContent:[Character] = ["#","E","B","E","B","E"]
fileprivate let str_subData:String = "player"

/*: "icon_talk_reply_voive" :*/
fileprivate let str_actualData:[Character] = ["i","c","o","n","_"]
fileprivate let str_makeName:String = "useralk"
fileprivate let str_labelData:String = "_voivesize let top inside"

/*: "#DCDCDC" :*/
fileprivate let str_userBorderName:String = "time as manager guard#DCDCDC"

/*: "text" :*/
fileprivate let str_mediumPathData:String = "hiddenxt"

/*: ": " :*/
fileprivate let str_centerData:String = "image "

/*: "gift" :*/
fileprivate let str_giftMessageTextValue:String = "toift"

/*: "Sent " :*/
fileprivate let str_appTitle:[Character] = ["S","e","n","t"," "]

/*: " x :*/
fileprivate let str_indicatorData:String = " xequal lab"

/*: "audio" :*/
fileprivate let str_matchUserName:String = "kitudio"

/*: ″" :*/
fileprivate let str_addTarData:String = "″"

/*: "img" :*/
fileprivate let str_userStateValue:[Character] = ["i","m","g"]

/*: "video" :*/
fileprivate let str_termsData:[Character] = ["v","i","d","e","o"]

/*: "map" :*/
fileprivate let str_fillValue:[Character] = ["m","a","p"]

/*: ": [Location]" :*/
fileprivate let str_arrayText:String = "pop make self view talk: [Lo"
...
class IngeminateButton: UIButton {
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.markTag(name: (String(str_deadlineBlockData) + String(str_modelMakeData)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var audioView: UIView = {
        ...
        v.backgroundColor = UIColor(hex: (String(str_hiddenContent) + str_subData.replacingOccurrences(of: "player", with: "B")))
    ...
    lazy var audioImg: UIImageView = {
        //: let img = UIImageView()
        let img = UIImageView()
        //: img.image = UIImage.markTag(name: "icon_talk_reply_voive")
        img.image = UIImage.markTag(name: (String(str_actualData) + str_makeName.replacingOccurrences(of: "user", with: "t") + "_reply" + String(str_labelData.prefix(6))))
        //: return img
        return img
        //: }()
    }()
    ...
    var direction: TMsgDirection = .MsgDirectionIncoming {
        ...
        didSet {
            ...
            if direction == .MsgDirectionIncoming {
                //: self.lineView.backgroundColor = UIColor.pullUpColor()
                self.lineView.backgroundColor = UIColor.pullUpColor()
                //: self.nameLab.textColor = UIColor.pullUpColor()
                self.nameLab.textColor = UIColor.pullUpColor()
                //: }else{
            } else {
                //: self.lineView.backgroundColor = UIColor(hex: "#DCDCDC")
                self.lineView.backgroundColor = UIColor(hex: (String(str_userBorderName.suffix(7))))
                //: self.nameLab.textColor = UIColor(hex: "#DCDCDC")
                self.nameLab.textColor = UIColor(hex: (String(str_userBorderName.suffix(7))))
            }
        }
    }
    ...
    var quoteModel: CopernicanSystemJsonModel? {
        ...
        didSet {
            ...
            if quoteModel.renderType == (str_mediumPathData.replacingOccurrences(of: "hidden", with: "te")) {
                //: self.nameLab.text = quoteModel.sendName + ": " +  quoteModel.renderData.content
                self.nameLab.text = quoteModel.sendName + ": " + quoteModel.renderData.content
                //: }else if quoteModel.renderType == "gift" {
            } else if quoteModel.renderType == (str_giftMessageTextValue.replacingOccurrences(of: "to", with: "g")) {
                //: self.nameLab.text = quoteModel.sendName + ": " + "Sent ".localized + quoteModel.renderData.giftNameLocal() + " x\(quoteModel.renderData.giftNum)"
                self.nameLab.text = quoteModel.sendName + ": " + (String(str_appTitle)).localized + quoteModel.renderData.send() + " x\(quoteModel.renderData.giftNum)"
                //: }else if quoteModel.renderType == "audio" {
            } else if quoteModel.renderType == (str_matchUserName.replacingOccurrences(of: "kit", with: "a")) {
            ...
            } else if quoteModel.renderType == (String(str_userStateValue)) {
                //: self.nameLab.text = quoteModel.sendName + ": "
                self.nameLab.text = quoteModel.sendName + ": "
                ...
                if quoteModel.renderData.previewUrl.count > 0 && isExists {
                    ...
                    self.imgView.sitImageDoing(urlStr: quoteModel.renderData.previewUrl)
                }
                //: spaceRight = 34
                spaceRight = 34
                //: }else if quoteModel.renderType == "video" {
            } else if quoteModel.renderType == (String(str_termsData)) {
                //: self.nameLab.text = quoteModel.sendName + ": "
                self.nameLab.text = quoteModel.sendName + ": "
                //: self.imgView.isHidden = false
                self.imgView.isHidden = false
                ...
                self.imgView.sitImageDoing(urlStr: quoteModel.renderData.coverUrl)
                //: spaceRight = 34
                spaceRight = 34
                //: }else if quoteModel.renderType == "map" {
            } else if quoteModel.renderType == (String(str_fillValue)) {
                //: self.nameLab.text = quoteModel.sendName + ": [Location]"
                self.nameLab.text = quoteModel.sendName + (String(str_arrayText.suffix(5)) + "cation]")
            }
