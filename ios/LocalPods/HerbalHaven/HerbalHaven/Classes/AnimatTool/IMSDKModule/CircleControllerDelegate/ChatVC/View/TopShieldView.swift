...
fileprivate let str_tagTitle:[UInt8] = [0xc3,0xc4,0xc3,0xde,0x82,0xc9,0xc5,0xce,0xcf,0xd8,0x90,0x83,0x8a,0xc2,0xcb,0xd9,0x8a,0xc4,0xc5,0xde,0x8a,0xc8,0xcf,0xcf,0xc4,0x8a,0xc3,0xc7,0xda,0xc6,0xcf,0xc7,0xcf,0xc4,0xde,0xcf,0xce]

private func outOfSight(actual num: UInt8) -> UInt8 {
    return num ^ 170
}
...
class TopShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func pathCreate(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return TopShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_tagTitle.map{outOfSight(actual: $0)}, encoding: .utf8)!)
    }
