...
fileprivate let str_evaluateValue:[UInt8] = [0xf2,0xf5,0xf2,0xef,0xb3,0xf8,0xf4,0xff,0xfe,0xe9,0xa1,0xb2,0xbb,0xf3,0xfa,0xe8,0xbb,0xf5,0xf4,0xef,0xbb,0xf9,0xfe,0xfe,0xf5,0xbb,0xf2,0xf6,0xeb,0xf7,0xfe,0xf6,0xfe,0xf5,0xef,0xfe,0xff]

/*: "Online Users" :*/
fileprivate let str_createName:String = "frame by called buttonOnli"
fileprivate let str_statusKitReturnContent:[Character] = ["s"]

/*: "ColorListCell" :*/
fileprivate let str_atAddTitle:[Character] = ["T","a","l","k","i","n","g","L","i","v"]
fileprivate let str_backLayerValue:String = "room from modeleR"
fileprivate let str_managerContent:String = "oomOnlmake image time"
fileprivate let str_stackData:String = "tCelllet show info"
...
class ErrorHiddenThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_evaluateValue.map{$0^155}, encoding: .utf8)!)
    }
    ...
    private lazy var dismissBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(ingredient), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLb: UILabel = {
        ...
        lb.text = (String(str_createName.suffix(4)) + "ne User" + String(str_statusKitReturnContent)).localized
        //: return lb
        return lb
        //: }()
    }()
...
extension ErrorHiddenThen {
    ...
    private func eventData() {
        ...
        ColumnThen().roomLightAdd(chatGroupId: self.chatGroupId) { succeed, result, _ in
...
extension ErrorHiddenThen: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = (String(str_atAddTitle) + String(str_backLayerValue.suffix(2)) + String(str_managerContent.prefix(6)) + "ineLis" + String(str_stackData.prefix(5)))
        ...
        cell?.startIn(model: self.DataSource[indexPath.row], index: indexPath.row)
        //: return cell!
        return cell!
    }
...
extension ErrorHiddenThen {
    ...
    func equalRed(chatGroupId: String) {
