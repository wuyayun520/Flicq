...
fileprivate let str_showPointName:[UInt8] = [0x83,0x88,0x83,0x8e,0x42,0x7d,0x89,0x7e,0x7f,0x8c,0x54,0x43,0x3a,0x82,0x7b,0x8d,0x3a,0x88,0x89,0x8e,0x3a,0x7c,0x7f,0x7f,0x88,0x3a,0x83,0x87,0x8a,0x86,0x7f,0x87,0x7f,0x88,0x8e,0x7f,0x7e]

fileprivate func ifSelf(center num: UInt8) -> UInt8 {
...
class ItemMiniView: LoopLightMiniView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_showPointName.map{ifSelf(center: $0)}, encoding: .utf8)!)
    }
...
extension ItemMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func scoop(liveUrl: String) {
...
extension ItemMiniView: TXLivePlayListener {
