...
let kLet_iconBottomValue = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kLet_sampleFormatClickContent = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let kLet_priceTitle = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct EqualHandyJSON: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
