...
enum ClickTitleSumerpolation: String {
    //: case AppleLogin
...
enum ManagerValueConvertible: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
enum DigitiserLoopFormLoginType {
    //: case LoginPhone
    case LoginPhone
    //: case LoginEmail
    case LoginEmail
...
/// 性别
//: enum Gender: String {
enum RowErrorScalarLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum OutOfSightSendable: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum RecordRankExpressionConvertible: Int {
    //: case isOnGoing = 0
...
@objc enum MaculeRelatableTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ComplexionSubscriptType: Int {
    //: case Unavailable = 0
...
enum ArrayCaseIterable: CaseIterable {
