...
class ModelBadgeLab: UILabel {
	var bagEnable: Bool = true
    ...
    private func videoBy() {
        ...
        layer.backgroundColor = UIColor.imageColor().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.biologyLaboratoryEqual(type: .Medium, fontSize: 11)
        font = UIFont.biologyLaboratoryEqual(type: .Medium, fontSize: 11)
...
class ViewColorReactiveCompatible: UILabel {
	var sectionQuantity: Int = 62
	var digitizerCount: Double = -12.5
	var requestTitle: String = "signal"
	var lightDictionary: [AnyHashable: String] = [:]
	var dataMagnitude: Int = 36
	var loadInterval: Double = 69.5
	var imageFrameText: String = "capture"
