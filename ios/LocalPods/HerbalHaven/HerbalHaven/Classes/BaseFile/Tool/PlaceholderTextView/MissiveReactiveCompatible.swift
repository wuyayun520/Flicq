...
/*: / :*/
fileprivate let str_observerTitle:String = "/"

/*: "\n" :*/
fileprivate let str_formatValue:[Character] = ["\n"]
...
// __CLOSE_PRINT__
//
//  MissiveReactiveCompatible.swift
//  MissiveReactiveCompatible
...
class MissiveReactiveCompatible: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        colorDown(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        colorDown(placeholder: nil, placeholderColor: nil)
    }
}
...
extension MissiveReactiveCompatible {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func colorDown(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(HeadwaterLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(HeadwaterLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-HeadwaterLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: SoundContainerInset().top, left: SoundContainerInset().left, bottom: SoundContainerInset().bottom, right: SoundContainerInset().right)
...
extension MissiveReactiveCompatible: UITextViewDelegate {
