...
/*: "id" :*/
fileprivate let str_methodHiddenData:[Character] = ["i","d"]
...
struct NextTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ClickTransformable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [NextTopTransformable]? // 相册
    ...
    var aiExtraInfo = ButtonHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct NextTopTransformable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func addEdit(compareTo: NextTopTransformable) -> Bool {
        //: return
        return
...
enum ColorActualPriorityTarget: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
