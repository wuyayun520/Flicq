...
/*: "Face verification" :*/
fileprivate let str_matchName:String = "Face verreturn let"
fileprivate let str_followingValue:[Character] = ["i"]
fileprivate let str_labelData:String = "fleadinga"
...
class LocationViewController: ToControllerPositionBaseRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        title = (String(str_matchName.prefix(8)) + String(str_followingValue) + str_labelData.replacingOccurrences(of: "leading", with: "ic") + "tion").localized
        //: self.createUI()
        self.obligatoUi()
        //: self.createUIConstraint()
        self.counteraction()
    
            if (mainView.layer.contentsRect.origin.y != 0) && (mainView.layer.shadowRadius == 1.41) {
                //: SWIFT_CUSTOM_DANGER_File_Call
                let draftTitle = YearView()

                mainView.addSubview(draftTitle)
            }
    ...
    lazy var mainView: ExaggerateView = {
        //: let view = TalkingVerificationExampleView()
        let view = ExaggerateView()
        //: return view
        return view
        //: }()
    }()
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = BalloonThen(photoImage: photo)
...
extension LocationViewController {
    ...
    func obligatoUi() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            HiddenToolReactiveCompatible.playerHead(true) { isOpen in
