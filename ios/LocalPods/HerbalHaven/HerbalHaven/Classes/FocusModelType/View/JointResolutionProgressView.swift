...
fileprivate let str_succeedData:[UInt8] = [0x53,0x54,0x53,0x4e,0x12,0x59,0x55,0x5e,0x5f,0x48,0x0,0x13,0x1a,0x52,0x5b,0x49,0x1a,0x54,0x55,0x4e,0x1a,0x58,0x5f,0x5f,0x54,0x1a,0x53,0x57,0x4a,0x56,0x5f,0x57,0x5f,0x54,0x4e,0x5f,0x5e]

private func indexIcon(label num: UInt8) -> UInt8 {
    return num ^ 58
}
...
// __CLOSE_PRINT__
//
//  JointResolutionProgressView.swift
//  AbroadTalking
//
...
class JointResolutionProgressView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_succeedData.map{indexIcon(label: $0)}, encoding: .utf8)!)
    }
...
extension JointResolutionProgressView {
    // 添加视图
    //: private func setupSubviews() {
    private func blockBack() {
