...
class MaleContextThen: NSObject {
...
extension MaleContextThen {
    /// 释放资源
    //: func shouldReleaseAllResource() {
    func removeResource() {
        //: destoryTRTCView()
        destoryPressPanoramicView()
    }
    
    /// 摄像头前后置切换
    //: func useFrontCamera(_ frontCamera: Bool) {
    func boxKodakCamera(_ frontCamera: Bool) {
        ...
        self.spectralColor(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func butylateCamera(_ openCamera: Bool) {
        ...
        self.gapService(isOpen: openCamera)
    }
    ...
    func makeEvent() {
        ...
        DispatchQueue.main.async {
            ...
            self.bayWindow(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension MaleContextThen {
    ...
    private func spectralColor(front: Bool) {
    ...
    private func gapService(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_nextTitle == true else {
            //: if isOpen {
            if isOpen {
...
extension MaleContextThen {
    ...
    func tell() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(inheritanceBack(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(contain(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(duringApp(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(pointBy(notif:)),
    ...
    @objc private func inheritanceBack(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func contain(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func duringApp(notif: Notification) {
    ...
    @objc func pointBy(notif: Notification) {
...
extension MaleContextThen {
    ...
    func bayWindow(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_nextTitle == true else {
...
//    }
    ...
    private func destoryPressPanoramicView() {
