...
/*: "&sr=6" :*/
fileprivate let str_arrayPageName:String = "view image array var make&sr=6"
...
enum ActualTextConvertible: String, CaseIterable {
...
class LiveShowManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func than(urlType: VaneOutputStream) -> String {
        //: var url = RecordAppManager.share.appConfigMode.urlH5Domain
        var url = RecordAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(RecordAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RecordAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(RecordAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : RecordAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(RecordAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RecordAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(RecordAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : RecordAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = RecordAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = RecordAppManager.share.appUserConfigMode.halfRechargePage.appending((String(str_arrayPageName.suffix(5))))
            //: url.append(RecordAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(RecordAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
